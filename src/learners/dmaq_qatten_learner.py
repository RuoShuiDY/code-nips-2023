from components.trajectory_tree import Tree
...
class DMAQ_qattenLearner:
    ...
    def sub_train(self, batch: EpisodeBatch, t_env: int, episode_num: int, mac, mixer, optimiser, params,
        ...
        targets = build_td_lambda_targets_with_value(rewards, terminated, mask, target_max_qvals, 
                                    self.args.n_agents, self.args.gamma, td_lambda, relay, pos)
    ...
    def train_with_template(self, batch: EpisodeBatch, t_env: int, episode_num: int, show_demo=False, save_data=None):
